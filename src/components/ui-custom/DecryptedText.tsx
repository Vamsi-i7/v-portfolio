...
export function DecryptedText({
  ...
  const initialDisplayText = useMemo(() => {
    const isEncrypted = animateOn === 'click' || animateOn === 'view' || animateOn === 'inViewHover'
    if (isEncrypted) {
      return text
        .split('')
        .map((char) => {
  ...
  }, [animateOn, triggerDecrypt, delay])
